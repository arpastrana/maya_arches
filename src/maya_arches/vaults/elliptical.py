...
class EllipticalVault(Vault):
    ...
    def points(self, num_points: int = 100) -> list[Point]:
        ...
        not guaranteed to be exactly twice the thickness of the vault, except 
        at the base and the top of the vault.
        """
...
class EllipticalTaperedVault(EllipticalVault):
    """
    A half-elliptical vault with a tapered intrados.
    """
    ...
    def _check_thickness(self):
        ...
        if self.thickness_top > self.height:
            raise ValueError("The top thickness of the vault cannot be greater than the height.")
        if self.thickness_bottom > self.width:
            raise ValueError("The bottom thickness of the vault cannot be greater than the width.")

    @property    
    def thickness(self) -> float:
        """
        The top thickness of the vault. 
